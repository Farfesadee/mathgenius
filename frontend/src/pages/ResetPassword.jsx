...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      setError(getFriendlyAuthMessage('resetPassword', error.message))
    } else {
      setSuccess(true)
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {[
                  ...
                  { label: 'Confirm Password', value: confirm, setValue: setConfirm },
                  ...
                  <div key={label}>
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        minLength={5}
                        className="w-full bg-[var(--color-paper)] border-2 border-[var(--color-border)] focus:border-[var(--color-teal)] rounded-xl px-4 py-3 pr-12 text-sm transition-colors"
                      />
                      <button
                        type="button"
